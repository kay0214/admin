...
import com.personal.generator.domain.ColumnDO;
import com.personal.generator.domain.TableDO;
import com.personal.generator.type.EnumGen;
...
public class GenUtils {
    ...
    private static Logger log = LoggerFactory.getLogger(com.personal.common.utils.GenUtils.class);
    ...
    public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns,
        ...
        map.put("datetime", DateUtils.getLocalDateTime());
        // 字段特性
    ...
    public static Map<String, String> getConfig() {
        ConfigService configService = com.personal.common.utils.SpringContextHolder.getBean(ConfigService.class);
