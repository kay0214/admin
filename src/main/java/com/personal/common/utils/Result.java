...
public class Result<T> implements Serializable {
    ...
    public static final Integer CODE_SUCCESS = EnumErrorCode.success.getCode();
    public static final Integer CODE_FAIL = EnumErrorCode.fail.getCode();
    public static final String MSG_SUCCESS = EnumErrorCode.success.getMsg();
    public static final String MSG_FAIL = EnumErrorCode.fail.getMsg();
    ...
    public static Result<String> buildByErrorCode(String errorCode) {
        try {
            ...
            return build(code, EnumErrorCode.getMsgByCode(code));
        } catch (NumberFormatException e1) {
            log.warn("错误码使用错误，异常内容请抛出EnumErrorCode类的枚举值");
            return build(EnumErrorCode.unknowFail.getCode(), EnumErrorCode.unknowFail.getMsg());
        }
    }
