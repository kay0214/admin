...
public class ShortUrlUtils {
    ...
    private static final String WEIBO_API_SHORT_URL = "http://api.t.sina.com.cn/short_url/shorten.json?source=3271760578&";
    ...
    public static List<UrlObject> convertShortUrl(List<String> urlList) {
        ...
        apiUrlList.forEach(url -> {
            List<UrlObject> urlObjects = JSONUtils.jsonToList(restTempate.getForObject(url, String.class), com.personal.common.utils.UrlObject.class);
    ...
    public static com.personal.common.utils.UrlObject convertShortUrl(String url) {
        return convertShortUrl(Arrays.asList(new String[]{url})).get(0);
    }


    public static void main(String[] args) {
        com.personal.common.utils.UrlObject urlObject = convertShortUrl("http://ifast.site");
        System.out.println(" - - - - - - - - - - - - - - - - - - - - - - - ");
