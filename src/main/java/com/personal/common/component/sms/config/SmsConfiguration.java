package com.personal.common.component.sms.config;

import com.personal.common.component.sms.support.MapSceneRepository;
import com.personal.common.component.sms.support.SceneRepository;
import com.personal.common.component.sms.support.SmsManager;
import com.personal.common.component.sms.support.SmsSender;
import com.personal.common.component.sms.support.aliyun.AliyunProperties;
import com.personal.common.component.sms.support.aliyun.AliyunSender;
import com.personal.common.component.sms.support.zhutong.ZhuTongProperties;
import com.personal.common.component.sms.support.zhutong.ZhuTongSender;
...
public class SmsConfiguration {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "project.sms.zt", name = "passwd")
    ...
    @Bean
    @ConditionalOnProperty(prefix = "project.sms.aliyun", name = "accessKeySecret")
    @ConditionalOnMissingBean(SmsSender.class)
