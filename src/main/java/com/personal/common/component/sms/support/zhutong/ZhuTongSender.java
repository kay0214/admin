package com.personal.common.component.sms.support.zhutong;
...
import com.personal.common.utils.CodecUtils;
...
public class ZhuTongSender implements SmsSender {
    ...
    private static final String SENDER_SERVER_URL = "http://www.ztsms.cn/sendNSms.do";
    ...
    private String buildURL(String mobile, String code, String content) {
        String tKey = DateUtils.getLocalDateTimeShort();
